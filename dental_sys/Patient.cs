...
namespace dental_sys
{
    public partial class Patient : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "dentistryDataSet.Appointment_Doctor". При необходимости она может быть перемещена или удалена.
            this.appointment_DoctorTableAdapter.Fill(this.dentistryDataSet.Appointment_Doctor);
